...
```bash
git clone --depth 1 --branch v2.2.0 https://github.com/tailwindlabs/heroicons.git /tmp/heroicons-src
python3 scripts/sync_heroicons.py --src /tmp/heroicons-src/optimized --version 2.2.0
```
